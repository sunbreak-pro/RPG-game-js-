...
export class Skill {
  ...
  type: "attack" | "heal";
  element?: string;
  power: (user: any) => number;
  log: (skillName: string, user: any, target: any, damage?: number) => void;
  Instruction: string;
...
export function activateSkill(skillIndex: number, _user: any, _target: any): void {
...
const instructionBox = document.getElementById("skill-instruction-box") as HTMLElement;
const instructionParagraph = document.getElementById("skill-instruction") as HTMLElement;
